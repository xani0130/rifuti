...
class CompletedScreen extends StatelessWidget {
  ...
  CompletedScreen(this.img, this.name, [this.tripPool = false]);

  @override
  Widget build(BuildContext context) {
    return BlocProvider<OrderMapBloc>(
      create: (context) => OrderMapBloc()..loadMap(),
      child: CompletedScreenBody(img, name, tripPool),
    );
  }
}

class CompletedScreenBody extends StatefulWidget {
  final String img;
  final String name;
  final bool tripPool;

  CompletedScreenBody(this.img, this.name, [this.tripPool = false]);

  @override
  _CompletedScreenBodyState createState() => _CompletedScreenBodyState();
}

class _CompletedScreenBodyState extends State<CompletedScreenBody> {
                              ...
                              Row(
                                children: [
                                  Icon(Icons.drive_eta,
                                      color: Colors.grey[400], size: 1.5.h),
                                  SizedBox(
                                    width: 5.5.w,
                                  ),
